...
module mint_nft::nftflix {
    ...
    fun init_module(resource_signer: &signer) {
        let collection_name = string::utf8(b"NFTFlix Anime");
        let description = string::utf8(b"Watch Animes and Earn NFTs");
        let collection_uri = string::utf8(b"https://nftflix.tech");
        let token_name = string::utf8(b"NFTFlix");
        let token_uri = string::utf8(b"https://aqua-solid-tarantula-394.mypinata.cloud/ipfs/QmaAJnw6XAtnXBNu19fE9QH3PzW13qVvfKVwWSmnJFDJgd");
